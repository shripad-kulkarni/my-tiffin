...
function checkPassword() {
	...
	if (pass != cpass) {
		document.getElementById('passalert').innerHTML = "Password must be same?"
	} else {
...
function checkCustomerPass() {
	var pass = document.getElementById('custpass').value
	var cpass = document.getElementById('custCpass').value
	if (pass != cpass) {
		document.getElementById('passalert2').innerHTML = "Password must be same?"
	} else {
...
// user login modal 
var umodal = document.getElementById("user-login-Modal");
var ubtn = document.getElementById("usermyBtn");
var uspan = document.getElementsByClassName("user-close")[0];
function usermyBtn(menuid) {
...
// Get the modal
var amodal = document.getElementById("adminLoginModel");
...
// payment modal
var pmodal = document.getElementById("paymentModal");
function paymentBtn() {
	...
	if(name=="" || mobile=="" || address==""){
		...
		var pmodal = document.getElementById("paymentModal");
		document.getElementById('paymentPrice').value =  document.getElementById('totalprice').value 
		pmodal.style.display = "block";
	}
}
function pymentclose() {
	var pmodal = document.getElementById("paymentModal");
...
function sleep(milliseconds) {
 ...
 async function fun() {
	   await sleep(5000);
	document.getElementById('pymentForm').innerHTML = "<div class='text-center text-success' style='font-size:20px;'>Payment Successfull!</div>"
	document.getElementById('ordBtn').hidden = false
	document.getElementById('pyBTn').hidden = true
	await sleep(2000);
	pymentclose()
 }
...
function messagePayment(){
	var upi = document.getElementById('upi').value
	 if(document.getElementById('upi').value=="" || upi.length<10){
		alert("Please enter valid UPI")
	 }else{
		 document.getElementById('pymentForm').innerHTML = "<div class='text-center text-danger'>Payment Processing</div>"
		 fun();
		}
	}
